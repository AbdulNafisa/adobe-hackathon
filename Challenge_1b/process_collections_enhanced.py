#!/usr/bin/env python3
"""
Challenge 1b: Persona-Driven Document Intelligence - Enhanced Version
...
class EnhancedPDFProcessor:
    """Enhanced PDF text extraction and section identification."""
    ...
    def _is_section_header(self, line: str) -> bool:
        ...
        if re.match(r'^[A-Z][a-z]', line) and len(line.split()) <= 8:
            return True
...
class EnhancedRelevanceScorer:
    """Enhanced scoring based on relevance to persona and job."""
    ...
    def __init__(self):
        ...
        self.job_keywords = {
            'plan a trip': ['itinerary', 'schedule', 'accommodation', 'transport', 'attraction', 
                           ...
                           'coastal adventures', 'culinary experiences', 'packing tips'],
    ...
    def score_section(self, section: Dict[str, Any], persona: str, job: str) -> float:
        ...
        score = (keyword_matches * 2) + (title_relevance * 8) + min(content_length / 50, 3)
        ...
        sample_titles = {
            'travel planner': ['comprehensive guide to major cities', 'coastal adventures', 'culinary experiences', 'packing tips'],
...
class EnhancedCollectionProcessor:
    """Enhanced processor for handling collections."""
...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: python process_collections_enhanced.py <collection_path>")
        print("Example: python process_collections_enhanced.py Collection_1")
        sys.exit(1)
    ...
    try:
        processor = EnhancedCollectionProcessor()
